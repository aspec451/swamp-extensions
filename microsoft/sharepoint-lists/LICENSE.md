...
Portions of this work — extensions/models/microsoft/_lib/auth.ts and
extensions/models/microsoft/_lib/graph.ts — are adapted from
@webframp/microsoft/teams (https://github.com/webframp/swamp-extensions),
Copyright 2026 Sean Escriva, licensed under the Apache License 2.0. Changes
from the originals are noted in those files' headers.
